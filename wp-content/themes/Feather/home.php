...
<?php if ( get_option('feather_blog_style') == 'false' ) { ?>
		...
		<div class="home-recent">
			<div class="recent-inner clearfix">
				<div class="description">
					<h4 class="title"><?php esc_html_e('Recent News & Articles','Feather'); ?></h4>
	...
	<?php if ( get_option('feather_display_recentwork_section') == 'on' ) { ?>
		<div class="home-recent">
			<div class="recent-inner clearfix">
				<div class="description">
					<h4 class="title"><?php esc_html_e('Photos & Video','Feather'); ?></h4>
		...
		<div class="partners">
			<div class="partners clearfix">
				<div class="description">
					<h4 class="title"><?php esc_html_e('Featured Partners','Feather'); ?></h4>
					<p>This week we're featuring NACHC's 50th Anniversary!</p>
				</div> <!-- end .description -->
				<div id="media-slider">
<p><a href="http://chchistory.nachc.org/" target="_blank" alt="NACHC 50th Anniversary"><img src="http://www.chcact.org/wp-content/uploads/2015/03/50Anniversary_Logo_SponsorVersion.jpg" class="partners" height="90"></a> 
