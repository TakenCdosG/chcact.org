...
<head>
    ...
    <link href="<?php echo $assets; ?>css/lpres.css" rel="stylesheet" type="text/css"/>
...
<div class="ctaLeft">
    ...
    <div class="innerCopy">
        ...
        <?php
        display(
            do_shortcode( $results->lp_sales_copy ),
...
if ( $results->webinar_date == "AUTO" ) {
    ...
    <div class="eventDate">
        ...
        <div class="dateInfo">
            <div class="dateHeadline"><?php echo $results->lp_webinar_headline ? $results->lp_webinar_headline : $autoDate_format; ?></div>
    ...
    <div class="optinFormArea" <?php if ( $paid_check == "no" ) {
        ...
        if ( $results->webinar_date == "AUTO" ) {
            ...
            if ( $results->lp_fb_button == "" || $results->lp_fb_button == "hide" ) {
                ...
                ?>" id="optinBTNFB" class="button"><?php display( $results->lp_fb_copy,
        ...
        if ( $results->lp_optin_button == "" || $results->lp_optin_button == "color" ) {
            ?>
            <a href="#" id="optinBTN"
               class=" optinBTN large button"><?php display( $results->lp_optin_btn,
                    "Register For The Webinar" ); ?></a>
        <?php
        } else {
            ?>
            <a href="#" id="optinBTN" class="optinBTN"><img src="<?php display( $results->lp_optin_btn_image, "" ); ?>"
                                                            width="327" border="0"/></a>
        <?php
        }
        ?>
